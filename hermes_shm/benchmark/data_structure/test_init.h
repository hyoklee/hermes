...
template <typename T>
struct StringOrInt {
  typedef typename hshm::type_switch<
      T, size_t, size_t, size_t, std::string, std::string, hipc::string,
      hipc::uptr<hipc::string>, bipc_string, bipc_string*>::type internal_t;
