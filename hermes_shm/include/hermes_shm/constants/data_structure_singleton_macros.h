...
#define HERMES_MEMORY_REGISTRY \
  hshm::GlobalSingleton<hshm::ipc::MemoryRegistry>::GetInstance()
#define HERMES_MEMORY_REGISTRY_REF \
  hshm::GlobalSingleton<hshm::ipc::MemoryRegistry>::GetRef()
...
#define HERMES_MEMORY_MANAGER_REF \
  hshm::GlobalSingleton<hshm::ipc::MemoryManager>::GetRef()
