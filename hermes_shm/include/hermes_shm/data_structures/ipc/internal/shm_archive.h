...
class ShmArchive {
 public:
  ...
  HSHM_ALWAYS_INLINE T* get() { return reinterpret_cast<T*>(obj_); }

  /** Pointer to internal object (const) */
  HSHM_ALWAYS_INLINE const T* get() const { return reinterpret_cast<T*>(obj_); }

  /** Reference to internal object */
  HSHM_ALWAYS_INLINE T& get_ref() { return reinterpret_cast<T&>(obj_); }
  ...
  HSHM_ALWAYS_INLINE T& operator*() { return get_ref(); }

  /** Dereference operator */
  HSHM_ALWAYS_INLINE const T& operator*() const { return get_ref(); }
