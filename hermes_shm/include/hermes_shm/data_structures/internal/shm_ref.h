...
struct _ShmRefShm {
  ...
  /** Destructor */
  ~_ShmRefShm() { obj_.UnsetDestructable(); }

  /** Constructor. */
  explicit _ShmRefShm(TypedPointer<T> other) { obj_.shm_deserialize(other); }

  /** Copy constructor */
  _ShmRefShm(const _ShmRefShm& other) { obj_.shm_deserialize(other.obj_); }

  /** Move constructor */
  _ShmRefShm(_ShmRefShm&& other) noexcept { obj_.shm_deserialize(other.obj_); }
  ...
  T& get_ref() { return obj_; }

  /** Get a constant ShmReference */
  const T& get_ref_const() const { return obj_; }
};
...
struct _ShmRefNoShm {
  ...
  /** Constructor. */
  explicit _ShmRefNoShm(T& other) { obj_ = &other; }

  /** Copy constructor */
  _ShmRefNoShm(const _ShmRefNoShm& other) { obj_ = other.obj_; }

  /** Move constructor */
  _ShmRefNoShm(_ShmRefNoShm&& other) noexcept { obj_ = other.obj_; }
...
struct ShmRef {
  ...
  /** Get ShmReference to the internal data structure */
  T& get_ref() { return obj_.get_ref(); }

  /** Get a constant ShmReference */
  const T& get_ref_const() const { return obj_.get_ref_const(); }

  /** DeShmReference operator */
  T& operator*() { return get_ref(); }

  /** Constant deShmReference operator */
  const T& operator*() const { return get_ref_const(); }
