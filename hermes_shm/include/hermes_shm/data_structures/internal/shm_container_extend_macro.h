...
#define SHM_CONTAINER_EXTEND_TEMPLATE(CLASS_NAME, TYPED_CLASS, TYPED_HEADER)   \
 public:                                                                       \
   ...
   *===================================*/                                      \
                                                                               \
  typedef TYPE_UNWRAP(TYPED_HEADER)                                            \
      header_t;      /**< Required by all ShmContainers */                     \
 ...
 public:                                                                       \
  ...
  bool shm_deserialize(Allocator *alloc, TYPE_UNWRAP(TYPED_HEADER) * header) { \
   ...
   * ===================================*/                                     \
                                                                               \
  /** Destructor */                                                            \
  ~TYPE_UNWRAP(CLASS_NAME)() { obj_.shm_destroy(true); }                       \
                                                                               \
  /** Shm Destructor */                                                        \
  void shm_destroy(bool destroy_header = true) {                               \
    ...
    if (destroy_header &&                                                      \
      ...
      GetAllocator()->template FreePtr<TYPE_UNWRAP(TYPED_HEADER)>(header_);    \
      UnsetValid();                                                            \
    }                                                                          \
  }                                                                            \
                                                                               \
  ...
  (TYPE_UNWRAP(CLASS_NAME) && other) noexcept : obj_(std::move(other)) {}      \
                                                                               \
  ...
  POINTER_T GetShmPointer() const {                                            \
    return GetAllocator()                                                      \
        ->template Convert<TYPE_UNWRAP(TYPED_HEADER), POINTER_T>(header_);     \
  }                                                                            \
                                                                               \
  /**====================================                                      \
   * Query Operations                                                          \
