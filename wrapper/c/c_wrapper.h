...
void HERMES_Create(hermes::HermesType mode, std::string server_config_path,
...
hermes::BlobId HERMES_Bucket_put_blob(hapi::Bucket &bucket,
                                      const char *blob_name, const char *blob,
                                      size_t blob_size);
hermes::BlobId HERMES_Bucket_get_blob_id(hapi::Bucket &bucket,
                                         const char *blob_name);
void HERMES_Bucket_get_blob(hapi::Bucket &bucket, hermes::BlobId &blob_id,
                            char *&blob, size_t &blob_size);
void HERMES_Bucket_destroy_blob(hapi::Bucket &bucket, hermes::BlobId &blob_id);
