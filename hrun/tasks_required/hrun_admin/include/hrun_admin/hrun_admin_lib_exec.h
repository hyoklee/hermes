...
void Run(u32 method, Task *task, RunContext &rctx) override {
  switch (method) {
    ...
    case Method::kGetOrCreateTaskStateId: {
      GetOrCreateTaskStateId(
          reinterpret_cast<GetOrCreateTaskStateIdTask *>(task), rctx);
      break;
    }
...
void Monitor(u32 mode, Task *task, RunContext &rctx) override {
  switch (task->method_) {
    case Method::kCreateTaskState: {
      MonitorCreateTaskState(
          mode, reinterpret_cast<CreateTaskStateTask *>(task), rctx);
      break;
    }
    case Method::kDestroyTaskState: {
      MonitorDestroyTaskState(
          mode, reinterpret_cast<DestroyTaskStateTask *>(task), rctx);
      break;
    }
    case Method::kRegisterTaskLib: {
      MonitorRegisterTaskLib(
          mode, reinterpret_cast<RegisterTaskLibTask *>(task), rctx);
      break;
    }
    case Method::kDestroyTaskLib: {
      MonitorDestroyTaskLib(mode, reinterpret_cast<DestroyTaskLibTask *>(task),
                            rctx);
      break;
    }
    case Method::kGetOrCreateTaskStateId: {
      MonitorGetOrCreateTaskStateId(
          mode, reinterpret_cast<GetOrCreateTaskStateIdTask *>(task), rctx);
      break;
    }
    case Method::kGetTaskStateId: {
      MonitorGetTaskStateId(mode, reinterpret_cast<GetTaskStateIdTask *>(task),
                            rctx);
      break;
    }
    case Method::kStopRuntime: {
...
void Del(u32 method, Task *task) override {
  switch (method) {
    case Method::kCreateTaskState: {
      HRUN_CLIENT->DelTask<CreateTaskStateTask>(
          reinterpret_cast<CreateTaskStateTask *>(task));
      break;
    }
    case Method::kDestroyTaskState: {
      HRUN_CLIENT->DelTask<DestroyTaskStateTask>(
          reinterpret_cast<DestroyTaskStateTask *>(task));
      break;
    }
    case Method::kRegisterTaskLib: {
      HRUN_CLIENT->DelTask<RegisterTaskLibTask>(
          reinterpret_cast<RegisterTaskLibTask *>(task));
      break;
    }
    case Method::kDestroyTaskLib: {
      HRUN_CLIENT->DelTask<DestroyTaskLibTask>(
          reinterpret_cast<DestroyTaskLibTask *>(task));
      break;
    }
    case Method::kGetOrCreateTaskStateId: {
      HRUN_CLIENT->DelTask<GetOrCreateTaskStateIdTask>(
          reinterpret_cast<GetOrCreateTaskStateIdTask *>(task));
      break;
    }
    case Method::kGetTaskStateId: {
      HRUN_CLIENT->DelTask<GetTaskStateIdTask>(
          reinterpret_cast<GetTaskStateIdTask *>(task));
      break;
    }
    case Method::kStopRuntime: {
      HRUN_CLIENT->DelTask<StopRuntimeTask>(
          reinterpret_cast<StopRuntimeTask *>(task));
      break;
    }
    case Method::kSetWorkOrchQueuePolicy: {
      HRUN_CLIENT->DelTask<SetWorkOrchQueuePolicyTask>(
          reinterpret_cast<SetWorkOrchQueuePolicyTask *>(task));
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      HRUN_CLIENT->DelTask<SetWorkOrchProcPolicyTask>(
          reinterpret_cast<SetWorkOrchProcPolicyTask *>(task));
      break;
    }
    case Method::kFlush: {
...
void Dup(u32 method, Task *orig_task,
  ...
  switch (method) {
    case Method::kCreateTaskState: {
      hrun::CALL_DUPLICATE(reinterpret_cast<CreateTaskStateTask *>(orig_task),
                           dups);
      break;
    }
    case Method::kDestroyTaskState: {
      hrun::CALL_DUPLICATE(reinterpret_cast<DestroyTaskStateTask *>(orig_task),
                           dups);
      break;
    }
    case Method::kRegisterTaskLib: {
      hrun::CALL_DUPLICATE(reinterpret_cast<RegisterTaskLibTask *>(orig_task),
                           dups);
      break;
    }
    case Method::kDestroyTaskLib: {
      hrun::CALL_DUPLICATE(reinterpret_cast<DestroyTaskLibTask *>(orig_task),
                           dups);
      break;
    }
    case Method::kGetOrCreateTaskStateId: {
      hrun::CALL_DUPLICATE(
          reinterpret_cast<GetOrCreateTaskStateIdTask *>(orig_task), dups);
      break;
    }
    case Method::kGetTaskStateId: {
      hrun::CALL_DUPLICATE(reinterpret_cast<GetTaskStateIdTask *>(orig_task),
                           dups);
      break;
    }
    case Method::kStopRuntime: {
      hrun::CALL_DUPLICATE(reinterpret_cast<StopRuntimeTask *>(orig_task),
                           dups);
      break;
    }
    case Method::kSetWorkOrchQueuePolicy: {
      hrun::CALL_DUPLICATE(
          reinterpret_cast<SetWorkOrchQueuePolicyTask *>(orig_task), dups);
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      hrun::CALL_DUPLICATE(
          reinterpret_cast<SetWorkOrchProcPolicyTask *>(orig_task), dups);
      break;
    }
    case Method::kFlush: {
  ...
  switch (method) {
    case Method::kCreateTaskState: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<CreateTaskStateTask *>(orig_task),
          reinterpret_cast<CreateTaskStateTask *>(dup_task));
      break;
    }
    case Method::kDestroyTaskState: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<DestroyTaskStateTask *>(orig_task),
          reinterpret_cast<DestroyTaskStateTask *>(dup_task));
      break;
    }
    case Method::kRegisterTaskLib: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<RegisterTaskLibTask *>(orig_task),
          reinterpret_cast<RegisterTaskLibTask *>(dup_task));
      break;
    }
    case Method::kDestroyTaskLib: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<DestroyTaskLibTask *>(orig_task),
          reinterpret_cast<DestroyTaskLibTask *>(dup_task));
      break;
    }
    case Method::kGetOrCreateTaskStateId: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<GetOrCreateTaskStateIdTask *>(orig_task),
          reinterpret_cast<GetOrCreateTaskStateIdTask *>(dup_task));
      break;
    }
    case Method::kGetTaskStateId: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<GetTaskStateIdTask *>(orig_task),
          reinterpret_cast<GetTaskStateIdTask *>(dup_task));
      break;
    }
    case Method::kStopRuntime: {
      hrun::CALL_DUPLICATE_END(replica,
                               reinterpret_cast<StopRuntimeTask *>(orig_task),
                               reinterpret_cast<StopRuntimeTask *>(dup_task));
      break;
    }
    case Method::kSetWorkOrchQueuePolicy: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<SetWorkOrchQueuePolicyTask *>(orig_task),
          reinterpret_cast<SetWorkOrchQueuePolicyTask *>(dup_task));
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<SetWorkOrchProcPolicyTask *>(orig_task),
          reinterpret_cast<SetWorkOrchProcPolicyTask *>(dup_task));
      break;
    }
    case Method::kFlush: {
      hrun::CALL_DUPLICATE_END(replica,
                               reinterpret_cast<FlushTask *>(orig_task),
                               reinterpret_cast<FlushTask *>(dup_task));
      break;
    }
  }
}
  ...
  switch (method) {
    ...
    case Method::kGetOrCreateTaskStateId: {
      hrun::CALL_REPLICA_START(
          count, reinterpret_cast<GetOrCreateTaskStateIdTask *>(task));
      break;
    }
    case Method::kGetTaskStateId: {
      hrun::CALL_REPLICA_START(count,
    ...
    case Method::kSetWorkOrchQueuePolicy: {
      hrun::CALL_REPLICA_START(
          count, reinterpret_cast<SetWorkOrchQueuePolicyTask *>(task));
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      hrun::CALL_REPLICA_START(
          count, reinterpret_cast<SetWorkOrchProcPolicyTask *>(task));
      break;
    }
    case Method::kFlush: {
...
TaskPointer LoadStart(u32 method, BinaryInputArchive<true> &ar) override {
  ...
  switch (method) {
    case Method::kCreateTaskState: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<CreateTaskStateTask>(task_ptr.shm_);
      ar >> *reinterpret_cast<CreateTaskStateTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kDestroyTaskState: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<DestroyTaskStateTask>(task_ptr.shm_);
      ar >> *reinterpret_cast<DestroyTaskStateTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kRegisterTaskLib: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<RegisterTaskLibTask>(task_ptr.shm_);
      ar >> *reinterpret_cast<RegisterTaskLibTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kDestroyTaskLib: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<DestroyTaskLibTask>(task_ptr.shm_);
      ar >> *reinterpret_cast<DestroyTaskLibTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kGetOrCreateTaskStateId: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<GetOrCreateTaskStateIdTask>(task_ptr.shm_);
      ar >> *reinterpret_cast<GetOrCreateTaskStateIdTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kGetTaskStateId: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<GetTaskStateIdTask>(task_ptr.shm_);
    ...
    case Method::kSetWorkOrchQueuePolicy: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<SetWorkOrchQueuePolicyTask>(task_ptr.shm_);
      ar >> *reinterpret_cast<SetWorkOrchQueuePolicyTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kSetWorkOrchProcPolicy: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<SetWorkOrchProcPolicyTask>(task_ptr.shm_);
...
u32 GetGroup(u32 method, Task *task, hshm::charbuf &group) override {
  switch (method) {
    ...
    case Method::kGetOrCreateTaskStateId: {
      return reinterpret_cast<GetOrCreateTaskStateIdTask *>(task)->GetGroup(
          group);
    }
    case Method::kGetTaskStateId: {
    ...
    case Method::kSetWorkOrchQueuePolicy: {
      return reinterpret_cast<SetWorkOrchQueuePolicyTask *>(task)->GetGroup(
          group);
    }
    case Method::kSetWorkOrchProcPolicy: {
      return reinterpret_cast<SetWorkOrchProcPolicyTask *>(task)->GetGroup(
          group);
    }
    case Method::kFlush: {
