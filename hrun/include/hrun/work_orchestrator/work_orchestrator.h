...
class WorkOrchestrator {
 ...
 public:
  ...
  HSHM_ALWAYS_INLINE
  void FinalizeRuntime() { stop_runtime_.store(true); }
  ...
  HSHM_ALWAYS_INLINE
  bool IsRuntimeAlive() { return !stop_runtime_.load(); }
  ...
  ABT_thread SpawnAsyncThread(FUNC &&func, TaskT *data) {
    ...
    int ret = ABT_thread_create_on_xstream(xstream_, func, (void *)data,
...
#define HRUN_WORK_ORCHESTRATOR (&HRUN_RUNTIME->work_orchestrator_)
