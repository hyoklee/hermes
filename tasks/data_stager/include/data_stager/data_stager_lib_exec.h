...
void Del(u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kRegisterStager: {
      HRUN_CLIENT->DelTask<RegisterStagerTask>(
          reinterpret_cast<RegisterStagerTask *>(task));
      break;
    }
    case Method::kUnregisterStager: {
      HRUN_CLIENT->DelTask<UnregisterStagerTask>(
          reinterpret_cast<UnregisterStagerTask *>(task));
      break;
    }
    case Method::kStageIn: {
    ...
    case Method::kStageOut: {
      HRUN_CLIENT->DelTask<StageOutTask>(
...
void Dup(u32 method, Task *orig_task,
  ...
  switch (method) {
    ...
    case Method::kRegisterStager: {
      hrun::CALL_DUPLICATE(reinterpret_cast<RegisterStagerTask *>(orig_task),
                           dups);
      break;
    }
    case Method::kUnregisterStager: {
      hrun::CALL_DUPLICATE(reinterpret_cast<UnregisterStagerTask *>(orig_task),
                           dups);
      break;
    }
    case Method::kStageIn: {
  ...
  switch (method) {
    ...
    case Method::kRegisterStager: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<RegisterStagerTask *>(orig_task),
          reinterpret_cast<RegisterStagerTask *>(dup_task));
      break;
    }
    case Method::kUnregisterStager: {
      hrun::CALL_DUPLICATE_END(
          replica, reinterpret_cast<UnregisterStagerTask *>(orig_task),
          reinterpret_cast<UnregisterStagerTask *>(dup_task));
      break;
    }
    case Method::kStageIn: {
      hrun::CALL_DUPLICATE_END(replica,
                               reinterpret_cast<StageInTask *>(orig_task),
                               reinterpret_cast<StageInTask *>(dup_task));
      break;
    }
    case Method::kStageOut: {
      hrun::CALL_DUPLICATE_END(replica,
                               reinterpret_cast<StageOutTask *>(orig_task),
                               reinterpret_cast<StageOutTask *>(dup_task));
      break;
    }
    case Method::kUpdateSize: {
      hrun::CALL_DUPLICATE_END(replica,
...
TaskPointer LoadStart(u32 method, BinaryInputArchive<true> &ar) override {
  ...
  switch (method) {
    ...
    case Method::kRegisterStager: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<RegisterStagerTask>(task_ptr.shm_);
      ar >> *reinterpret_cast<RegisterStagerTask *>(task_ptr.ptr_);
      break;
    }
    case Method::kUnregisterStager: {
      task_ptr.ptr_ =
          HRUN_CLIENT->NewEmptyTask<UnregisterStagerTask>(task_ptr.shm_);
