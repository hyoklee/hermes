...
void Del(u32 method, Task *task) override {
  switch (method) {
    ...
    case Method::kAllocate: {
      HRUN_CLIENT->DelTask<AllocateTask>(
    ...
    case Method::kStatBdev: {
      HRUN_CLIENT->DelTask<StatBdevTask>(
          reinterpret_cast<StatBdevTask *>(task));
      break;
    }
    case Method::kUpdateScore: {
      HRUN_CLIENT->DelTask<UpdateScoreTask>(
          reinterpret_cast<UpdateScoreTask *>(task));
      break;
    }
  }
}
...
void Dup(u32 method, Task *orig_task,
  ...
  switch (method) {
    ...
    case Method::kUpdateScore: {
      hrun::CALL_DUPLICATE(reinterpret_cast<UpdateScoreTask *>(orig_task),
                           dups);
      break;
    }
  }
...
void DupEnd(u32 method, u32 replica, Task *orig_task, Task *dup_task) override {
  switch (method) {
    ...
    case Method::kWrite: {
      hrun::CALL_DUPLICATE_END(replica,
                               reinterpret_cast<WriteTask *>(orig_task),
                               reinterpret_cast<WriteTask *>(dup_task));
      break;
    }
    case Method::kRead: {
      hrun::CALL_DUPLICATE_END(replica, reinterpret_cast<ReadTask *>(orig_task),
                               reinterpret_cast<ReadTask *>(dup_task));
      break;
    }
    case Method::kAllocate: {
      hrun::CALL_DUPLICATE_END(replica,
                               reinterpret_cast<AllocateTask *>(orig_task),
                               reinterpret_cast<AllocateTask *>(dup_task));
      break;
    }
    case Method::kFree: {
      hrun::CALL_DUPLICATE_END(replica, reinterpret_cast<FreeTask *>(orig_task),
                               reinterpret_cast<FreeTask *>(dup_task));
      break;
    }
    case Method::kStatBdev: {
      hrun::CALL_DUPLICATE_END(replica,
                               reinterpret_cast<StatBdevTask *>(orig_task),
                               reinterpret_cast<StatBdevTask *>(dup_task));
      break;
    }
    case Method::kUpdateScore: {
      hrun::CALL_DUPLICATE_END(replica,
                               reinterpret_cast<UpdateScoreTask *>(orig_task),
                               reinterpret_cast<UpdateScoreTask *>(dup_task));
      break;
    }
  }
}
